...
class ExpenseLineForm(ModelForm):
  ...
  begin_at_date = forms.DateField(label=ugettext_lazy('Begin at date'), widget=DateInput(attrs={'placeholder':ugettext_lazy('DD.MM.YYYY'), 'class':'short-input begin_at_date datepicker'}),
   input_formats=('%d.%m.%Y',), required=True)
  begin_at_time = forms.TimeField(label=ugettext_lazy('Begin at time'), input_formats=('%H.%M',), widget=TimeInput(attrs={'placeholder':ugettext_lazy('HH.MM'), 'class':'hidden-start short-input begin_at_time'}), required=False)
  ended_at_date = forms.DateField(label=ugettext_lazy('Ended at date'),
    input_formats=('%d.%m.%Y',),
    required=False, widget=DateInput(attrs={'placeholder':ugettext_lazy('DD.MM.YYYY'), 'class':'hidden-start short-input ended_at_date datepicker'}))
